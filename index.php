  ...
  <body>
    <header class="jumbotron">
      ...
      <span class="" style="text-align: center;"> 
        <address>
        <a href="http://thesocietea.org" target="_blank">www.thesocietea.org</a><br />
        <a href="mailto:#">info@thesocietea.org</a><br />
        </address>
      </span>
    </header>
    <div  style="text-align: center; margin: 20px">
      ...
      <br />
      <h3 style="text-style: italic">Tisanes* (Herbal Tea)</h3>
    ...
    <div class="notes">
      ...
      <p>* Tisanes are much less strict than normal teas with regard to water
